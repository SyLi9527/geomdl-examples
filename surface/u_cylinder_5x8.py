...
surf.ctrlpts_size_v = 8

# Set control points
d2_ctrlpts = exchange.import_txt("u_cylinder_5x8.ctrlpts", separator=" ")
...
surf.knotvector_v = utilities.generate_knot_vector(3, 8)
...
exchange.export_obj(surf, "u_cylinder_5x8.obj")
